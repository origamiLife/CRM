...
class WorkRequest extends StatefulWidget {
  const WorkRequest({Key? key, required this.employee}) : super(key: key);
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: (approve.del_status == '' )
                            ? Colors.orange :(approve.del_status == 'N')?Colors.red
                            : Colors.green,
                        width: (approve.del_status != 'Y') ? 2 : 2,
                      ),
                    ),
                    child: Padding(
                      padding: const EdgeInsets.all(8),
                      child: Column(
                        ...
                        children: [
                          ...
                          Divider(
                            color: hexToColor(approve.leave_type_color).withOpacity(0.5),
                            thickness: 1,
                          ),
                          Row(
                            children: [
